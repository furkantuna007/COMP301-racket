  ...
  (define apply-procedure
    (lambda (proc1 arg)
      (cases proc proc1
        ...
        (nested-procedure (bvar count pname body saved-env)
           (begin (set! saved-env (extend-env count (num-val (+ 1 (expval->num (apply-env saved-env count)))) saved-env))
                  (recursive-displayer pname (expval->num (apply-env saved-env count)))
