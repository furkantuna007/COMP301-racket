    ...
    (lambda (env search-sym)
      (cases environment env
              ...
              (cases expval val
                (proc-val (procedure)
                          (cases proc procedure
                            (nested-procedure (bvar count pname body env)
                                              (proc-val (nested-procedure bvar count pname body env)))
                            (else val)))
                (else val))
        ...
        ; #####################################################
         ...
         (extend-env-rec-nested (p-name b-var count p-body saved-env)
                                (if (eqv? search-sym p-name)
